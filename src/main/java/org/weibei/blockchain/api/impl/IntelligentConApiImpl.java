...
import org.weibei.blockchain.api.IIntelligentConApi;
...
public class IntelligentConApiImpl implements IIntelligentConApi {
	...
	public String createContractComponents(String params) {
		...
		try {
			...
			String description = json.has("description") == true ? json
					.getString("description") : "";
		    String value = json.has("value") == true ? json
							.getString("value") : "";
			String status = json.has("status") == true ? json
					.getString("status") : "";
